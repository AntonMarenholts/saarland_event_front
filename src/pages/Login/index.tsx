    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      <div className="bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4 text-white">
        ...
        <div className="relative flex py-5 items-center">
          ...
          <span className="flex-shrink mx-4 text-gray-400 text-sm">{t('or_separator')}</span>
          <div className="flex-grow border-t border-gray-600"></div>
        </div>
        ...
        <form onSubmit={handleSubmit(handleLogin)} className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <Link to="/register" className="inline-block align-baseline font-bold text-sm text-cyan-500 hover:text-cyan-400">
              {t('create_account_link')}
            </Link>
          </div>
          {message && (
            <div className="mt-4 p-4 text-sm text-red-200 bg-red-900 border border-red-500 rounded-lg" role="alert">
              {message}
            </div>
          )}
        </form>
